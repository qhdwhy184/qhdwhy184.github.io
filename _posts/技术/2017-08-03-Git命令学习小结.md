...
|[How to merge from branch in another repository](https://stackoverflow.com/questions/3402599/how-do-you-merge-two-git-branches-that-are-in-different-local-repos-folders/3402873)|1. add that repository as a remote one  2.pull the branch in remote repo to local repo branch. 3.merge from that local branch|
